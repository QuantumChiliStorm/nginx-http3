...
sed -i 's|--with-mail --with-mail_ssl_module --with-file-aio --with-threads --with-stream --with-stream_realip_module --with-stream_ssl_module --with-stream_ssl_preread_module|--with-pcre-jit - --with-openssl=$(CURDIR)/debian/modules/openssl|g' rules
cd ..
